...
from ultralytics.tensorleap_folder.pose.dataset import build_yolo_dataset
...
def validate_supported_models(pt_name,arch_name):
    supported_versions = [
        ...
        "yolo12l", "yolo12m", "yolo12n", "yolo12s", "yolo11s-pose"
    ]
...
def set_leap_yaml2root(cfg):
    ...
    shutil.copy(Path(__file__).resolve().parent / 'leap.yaml', root / 'leap.yaml')
